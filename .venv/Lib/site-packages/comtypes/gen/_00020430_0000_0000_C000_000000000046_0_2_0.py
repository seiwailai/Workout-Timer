...
IFontDisp = Font
__all__ = [ 'OLE_YSIZE_HIMETRIC', 'IPictureDisp', 'OLE_CANCELBOOL',
           'FONTUNDERSCORE', 'OLE_XSIZE_HIMETRIC', 'Unchecked',
           'IFontEventsDisp', 'OLE_XSIZE_PIXELS', 'VgaColor',
           'OLE_XPOS_CONTAINER', 'FONTSIZE', 'Checked',
           'OLE_YPOS_CONTAINER', 'Monochrome', 'FONTITALIC',
           'FONTBOLD', 'Gray', 'OLE_COLOR', 'Color', 'StdFont',
           'FontEvents', 'Default', 'FONTSTRIKETHROUGH', 'Font',
           'StdPicture', 'OLE_OPTEXCLUSIVE', 'OLE_XPOS_PIXELS',
           'OLE_YSIZE_CONTAINER', 'IFontDisp', 'OLE_XSIZE_CONTAINER',
           'OLE_ENABLEDEFAULTBOOL', 'LoadPictureConstants',
           'OLE_YSIZE_PIXELS', 'OLE_YPOS_HIMETRIC', 'FONTNAME',
           'IPicture', 'OLE_TRISTATE', 'IFont', 'OLE_XPOS_HIMETRIC',
           'OLE_YPOS_PIXELS', 'OLE_HANDLE', 'Picture']
